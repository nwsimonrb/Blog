...
featured_image: assets/images/posts/API_connectors/ca_rental_usecase.png
featured: false
hidden: true 
---
...
{% include image-caption.html imageurl="/assets/images/posts/API_Connectors/ca_rental_usecase.png" title="ca_rental_use_case" caption="Adaptive IT-strategy applied to real-time carbon accounting for an e-bike rental service" %}
